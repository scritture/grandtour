...
![](images/incomunicazioni-326x245.jpg){fig-align="center"}
...
Anche il più mediocre pubblicitario può sottoscrivere entusiasticamente tale evenienza, senza però rendersi conto di dove può andare a parare, rimuovendone quanto possibile effetti e cause, e persino lo stesso ruolo dell'inconscio. Come segnala Massimo Recalcati, lacaniano con la vocazione di districare argomentazioni complesse, l'inconscio viene praticamente «*disabbonato*» laddove ci si ingessa in identificazioni conformiste, in chiusure narcisistiche assolute, in «*godimenti*» autistici nelle quali la riproduzione dello Stesso prende il posto dell'incontro con l'Altro.[^16]
...
Circondati da un pensiero dominante che sembra democratico ma che procede risolutamente con un altro passo, l'immagine pubblica e pubblicitaria della democrazia permette di negare che propria la sua concreta esperienza ne stia minando i fondamenti e l'affidabilità.
